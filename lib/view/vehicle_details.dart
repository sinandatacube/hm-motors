...
import 'package:hm__motors/controller/vehicle_details_controller.dart';
import 'package:hm__motors/global_functions.dart';
import 'package:hm__motors/model/vehicle_details_model.dart';
import 'package:hm__motors/provider/car_details_provider.dart';
import 'package:hm__motors/url.dart';
import 'package:hm__motors/view/utitlities/error_page.dart';
import 'package:hm__motors/view/utitlities/money_format.dart';
import 'package:hm__motors/view/utitlities/no_network.dart';
import 'package:hm__motors/view/utitlities/photo_view.dart';
...
class _VehicleDetailsState extends State<VehicleDetails> {
  ...
  bool isFav = false;
  late List<String> wishlistItems;
  getwishlist() async {
  ...
  Widget _buildBottomBar(BuildContext context, VehicleDetailsModel data) {
    return Container(
      width: width,
      height: 60,
          ...
          Card(
            ...
            child: IconButton(
              onPressed: isSkip
                  ? () => buildloginDialog(context)
                  : () async {
                      wishlistItems = await VehicleDetailsController()
                          .addToWishlist(data.id, wishlistItems);
