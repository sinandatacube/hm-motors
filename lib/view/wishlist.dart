...
class _WishListState extends State<WishList> {
              ...
              builder: (context, AsyncSnapshot snapshot) {
                if (snapshot.hasData) {
                  ...
                  return wishlistItems.isEmpty
                      ...
                      : FutureBuilder(
                          future: ApiController().fetchWishlist(wishlistItems),
                          builder: (context, AsyncSnapshot snapshot) {
                            if (snapshot.hasData) {
  ...
  Widget _buildBody(BuildContext context, WishListModel data) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return InkWell(
            onTap: current.isInStock == "0"
                ? null
                : () => navigate(
                    VehicleDetails(
                        purchaseId: current.id, thumbImage: current.imgUrl),
                    false),
            child: Card(
